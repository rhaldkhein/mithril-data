...
(function(global, factory) { // eslint-disable-line
	...
	m.startComputation = function(id) {
		pendingRequests++
		console.log(id, pendingRequests, "+");
	}
	m.endComputation = function(id) {
		if (pendingRequests > 1) {
			...
			pendingRequests = 0
			m.redraw()
			console.log(id, pendingRequests, "- redraw");
		}
	}
	...
	m.request = function(options) {
		var __id = _.uniqueId('c')
		if (options.background !== true) m.startComputation(__id)
		var deferred = new Deferred()
		...
		options.onload = options.onerror = function(ev) {
			try {
				...
				if (options.background !== true) m.endComputation(__id)
			}
		}
